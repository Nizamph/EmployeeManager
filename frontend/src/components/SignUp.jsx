      ...
      <div className='bg-white p-8 rounded shadow-md w-96'>
        ...
        <form onSubmit={authenticationHandler}>
          ...
          <div className='text-center'>
            <button
              type='submit'
              className='bg-blue-950 text-white py-2 px-4 rounded-md hover:bg-blue-900 focus:outline-none focus:shadow-outline-blue'>
          ...
          <div className='text-center'>
            <button
              type='submit'
              className='bg-blue-950 mt-5 text-white py-2 px-4 rounded-md hover:bg-blue-900 focus:outline-none focus:shadow-outline-blue'
